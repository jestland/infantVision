...
def main():
    csv_file_path = 'E:\project\infantVision\data\infantVisionDataInfo.csv'
    plainbackground_path = 'E:\project\infantVision\data\plain background'
    objectsfixation_path = 'E:\project\infantVision\data\objects fixation'
    fixation64_path = 'E:/project/infantVision/data/fixation cropping/64x64'
    fixation128_path = 'E:/project/infantVision/data/fixation cropping/128x128'
    ...
    plt.savefig('E:/project/infantVision/results/data analysis/size of datasets.pdf', pad_inches=0)
    plt.show()
    ...
    # plt.savefig('E:/project/infantVision/results/data analysis/Infant fixation proportion after cropping.pdf', pad_inches=0)
    # plt.show()
    ...
    # plt.xlabel('labels')
    # plt.xticks(rotation=30)
    # plt.savefig('E:/project/infantVision/results/data analysis/Plain dataset.pdf', pad_inches=0)
    # plt.show()
    ...
    # plt.xticks(rotation=30)
    # ax.ticklabel_format(style='sci', scilimits=(-1,2), axis='y', useMathText=True)
    # plt.savefig('E:/project/infantVision/results/data analysis/Object fixation dataset.pdf', pad_inches=0)
    # plt.show()
